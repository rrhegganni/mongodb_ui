	...
	var Login = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { className: 'form-horizontal pull-right loginFormWidth', onSubmit: this.handleSubmit },
	        React.createElement(
	          'fieldset',
	          null,
	          React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'label',
	              { 'for': 'userName', className: 'col-lg-2 control-label labelFieldSize' },
	              'User Name'
	            ),
	            React.createElement(
	              'div',
	              { 'class': 'col-lg-10' },
	              React.createElement('input', { type: 'text', className: 'form-control fieldSize', id: 'userName', onChange: this.setUserName, placeholder: 'Enter your user name' }),
	              this.userNameEmpty == true ? React.createElement(
	                'div',
	                null,
	                ' User Name is empty '
	              ) : ""
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'label',
	              { 'for': 'inputPassword', className: 'col-lg-2 control-label labelFieldSize' },
	              'Password'
	            ),
	            React.createElement(
	              'div',
	              { 'class': 'col-lg-10' },
	              React.createElement('input', { type: 'password', className: 'form-control fieldSize', id: 'inputPassword', onChange: this.setPassword, placeholder: 'Password' }),
	              this.passwordEmpty == true ? React.createElement(
	                'div',
	                null,
	                ' Password empty '
	              ) : ""
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'div',
	              { className: 'col-lg-10 col-lg-offset-2 submitDivAlign' },
	              React.createElement(
	                'button',
	                { type: 'submit', className: 'btn btn-primary submitButtonWidth' },
	                'Login'
	              )
	            )
	          )
